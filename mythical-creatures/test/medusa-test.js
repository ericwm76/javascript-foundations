...
describe('Medusa', function() {
  ...
  it('should unstone the the first victim and stone the 4th coming in', function() {
    ...
    var person1 = new Person('Kirk')
    var person2 = new Person('Elyse')
    var person3 = new Person('Scott')
    var person4 = new Person('Ann')
    // medusa stares at first victim
    medusa.stare(person1)
    // assert that the first victim is stoned
    assert.equal(person1.isStoned, true)
    ...
    assert.equal(person4.isStoned, true)
    // assert that the first victim is not stoned
    assert.equal(person1.isStoned, false)
  });
})
